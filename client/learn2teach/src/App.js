  ...
  <div className="relative bg-gray-200">
    ...
    <div className="relative max-w-5xl mx-auto">
      ...
      <div className="container flex justify-between items-center">
        <div className="text-3xl text-green-1000"><span>lean<span className="text-blue-500">N</span>teach
        </span></div>
        <nav>
          <ul className="tracking-wide flex items-center font-bold">
              <li className="mr-8"><span className="text-gray-800 hover:text-gray-600">Login</span></li>
            <li className="mr-8"><span className="text-gray-800 hover:text-gray-600">Sign Up</span></li>
...
<div className="flex flex-wrap">
      ...
      <div className="flex flex-col px-4 py-10 w-full sm:w-1/2 border-t-2 sm:border-t border-gray-200">
        <div className="flex flex-grow">
            ...
            <div className="font-bold pl-16">
                <div className="text-4xl">
                     Learn and teach
                </div>
                <div className="text-green-1000 text-2xl">A community to learn and grow together</div>
              </div>
      ...
      <div className="container-inner mx-auto mt-8 w-3/5">
            ...
            hover:text-black border border-green-1000
            text-white font-bold py-2 px-4 rounded-full">Get Started</button>
            </div>
          </div>


<div>
<h1 className="sm:font-light text-2xl sm:text-3xl md:text-4xl text-green-900 mt-6 text-center">Recent requests</h1>
<p className="sm:text-xl text-gray-600 mt-3 leading-relaxed text-center p-4">Pick a topic, create content, submit to teach the world.</p>

              <div className="flex justify-center">
                   <div className="flex-col">

                      <h3 className="text-center p-1">Developing Angular Js Directive</h3>
                      <h3 className="text-center p-1">Navigation in React Native</h3>
                      <h3 className="text-center p-1">UI/UX Introduction</h3>
                      <h3 className="text-center p-1">Introduction to Vue Js</h3>

                   </div>
                  
              </div>
              <div className="flex justify-center p-6">
                    <button className="bg-white border text-green-1000 border-green-1000 
                    font-bold py-2 px-4 rounded-full hover:text-white hover:bg-black">View More</button>
              </div>
  </div>


<div>
    <h1 className="sm:font-light text-2xl sm:text-3xl md:text-4xl text-green-900 mt-6 text-center">Review Vote and Share</h1>
...
<div className="flex flex-col px-4 py-10 w-full sm:w-1/2 border-t-2 sm:border-t border-gray-200">
  <div className="flex flex-grow">
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
          <div className="p-6">
              <h2 className="font-medium text-gray-800 text-lg p-2">Solving Algebra</h2>
              <p className="text-gray-600 text-sm p-2">
                 Solving real World Problems using Applied Mathematics, and this is my first Solution
              </p>
          </div>
          <div className="flex justify-around">
              <div>
                <p className="text-gray text-sm leading-none p-1">Video</p>
                <p className="text-gray text-sm leading-none p-1">Illustration</p>
                <p className="text-gray text-sm leading-none p-1">Text</p>
              </div>
              <div className="flex-col">
                    <div className="flex justify-center">
                       <img className="w-10 h-10 rounded-full mr-4 mb-2" src="https://uinames.com/api/photos/female/9.jpg" alt="Avatar of Grace Myalla" />
                    </div>
                    <div className="flex justify-center">
                        <p className="p-2 text-gray text-sm leading-none">Grace Myalla</p>
                    </div> 
               </div>
            </div> 
          </div>
...
<div className="bg-gray-100 border-t-2 border-gray-200">
    <h1 className="sm:font-light text-2xl sm:text-3xl md:text-4xl text-green-900 mt-6 text-center">Testimonials</h1>
   <div className="flex flex-wrap">
   ...
   <div className="flex flex-col px-12 py-10 w-full sm:w-1/2 border-t-2 sm:border-l sm:border-t border-gray-200">
     <div className="flex flex-grow">
       <div className="max-w-sm rounded overflow-hidden shadow-lg">
           <div className="flex justify-center">
             <p className="p-6 text-gray-600 mt-1 text-sm md:text-base">Learning to teach has been a wonderful community, it has helped me be able to share my knowledge with the community and learn from it.</p>
           </div>
           <div className="flex justify-center">
             <img className="w-10 h-10 rounded-full mr-4 mb-2" src="https://uinames.com/api/photos/female/9.jpg" alt="Avatar of Grace Myalla" />
           </div>
  ...
  <footer className="bg-green-1000 text-white">
    <div className="container mx-auto flex items-center justify-between py-8 px-8">
      <div className="flex items-center text-gray-600">Copyright 2019. All rights Reserved</div>
